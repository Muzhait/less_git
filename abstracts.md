...
### Выделение текста
1. Пока ничего нового. Ещее одна не обязательная запись.

2. Альтернативные способы выделения жирным или курсивом * или _ нужны для совмещения **_текст может быть курсивом и полужирным_-**
